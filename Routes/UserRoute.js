...
const { friend_request, accept_request, cancel_request, unfriend,
    getUserDetails, alFriends, requested_friend, getAllUser, addProfilePicture,
    editBio, editCover, removeCover, getPhotos, searchUserAdd, searchUserRemove,
    visitProfile, myFriends, hobbiesUpdate, socialLinkAdd, addFeatureImage,
    liveInCurrentCity,
    CurrentCity,
    relationship,
    phonNumber,
...
Router.route('/work')
    .post(private, workAdd)
    .put(private, workRemove)
